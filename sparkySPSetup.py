...
def printHelp():
    ...
    print()
    print('    An arbitrary number of domains may be given for each subaccount, one per line.')
    print('    Tracking domain may be specified in the third row, per subaccount.')
